          ...
          <div className={styles.rightSection}>
            <div className={styles.socialIcons}>
              ...
              <Link href="https://tiktok.com" aria-label="TikTok">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M9 12a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm10-9v5a4 4 0 0 1-4 4h-1v-2a6 6 0 0 0-6-6H7" />
              ...
              <Link href="https://pinterest.com" aria-label="Pinterest">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  ...
                  <path d="M8 11.5c0 .7.4 1.2 1 1.5v1m6-2.5a3.5 3.5 0 1 0-7 0 3.5 3.5 0 0 0 7 0zm1 7L13 17l-2 3" />
                </svg>
              </Link>
          ...
          <ul className={styles.navList}>
              ...
              {activeMenu === 'publications' && subMenus['publications'] && (
                ...
                >
                  <ul className={styles.submenuList}>
                    {subMenus['publications'].map((item) => (
                      <li key={`publications-${item.label}`}>
            ...
            >
              ...
              {activeMenu === 'articles' && subMenus['articles'] && (
                ...
                >
                  <ul className={styles.submenuList}>
                    {subMenus['articles'].map((item) => (
                      <li key={`articles-${item.label}`}>
                        <Link href={item.href} className={styles.submenuLink}>
                          {item.label}
                        </Link>
                      </li>
            ...
            >
              ...
              {activeMenu === 'videos' && subMenus['videos'] && (
                ...
                >
                  <ul className={styles.submenuList}>
                    {subMenus['videos'].map((item) => (
                      <li key={`videos-${item.label}`}>
                        <Link href={item.href} className={styles.submenuLink}>
                          {item.label}
                        </Link>
                      </li>
            ...
            >
              ...
              {activeMenu === 'marketplace' && subMenus['marketplace'] && (
                ...
                >
                  <ul className={styles.submenuList}>
                    {subMenus['marketplace'].map((item) => (
                      <li key={`marketplace-${item.label}`}>
                        <Link href={item.href} className={styles.submenuLink}>
                          {item.label}
                        </Link>
                      </li>
            ...
            >
              ...
              {activeMenu === 'profiles' && subMenus['profiles'] && (
                ...
                >
                  <ul className={styles.submenuList}>
                    {subMenus['profiles'].map((item) => (
                      <li key={`profiles-${item.label}`}>
                        <Link href={item.href} className={styles.submenuLink}>
                          {item.label}
                        </Link>
                      </li>
