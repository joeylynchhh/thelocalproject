...
const profiles = [
  ...
  },
  {
    id: 104,
    name: 'Oblica',
    ccategory: 'ARCHITECTURE & INTERIOR DESIGN',
...
export default function ArchitectureProfilesPage() {
      ...
      <div className={styles.profileSection}>
        <div className={styles.profileGrid}>
          ...
          <ProfileCard profile={profiles.find(p => p.name === 'A Design Studio') || {
            ...
            image: '/images/profiles/placeholder.jpg',
            slug: 'a-design-studio'
          }} />
