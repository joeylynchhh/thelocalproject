      ...
      <div className={styles.content}>
        ...
        <div className={styles.featuredProductsSection}>
          ...
          <div className={styles.featuredProductsGrid}>
            ...
            {/* Product 12 - Utzon(s) Lounge Chair */}
            ...
            {/* Third Row - From the image */}
            {/* Product 13 - Tuffeau */}
            <Link href="/marketplace/products/tuffeau" className={styles.productCard}>
              <div className={styles.productImage}>
                <Image 
                  src="/images/products/tuffeau.jpg" 
                  alt="Tuffeau" 
                  width={400} 
                  height={300}
                />
              ...
              <div className={styles.productInfo}>
                <span className={styles.brandName}>TIENTO</span>
                <h3>Tuffeau</h3>
              </div>
            </Link>
            
            {/* Product 14 - Smoked */}
            <Link href="/marketplace/products/smoked" className={styles.productCard}>
              <div className={styles.productImage}>
                <Image 
                  src="/images/products/smoked.jpg" 
                  alt="Smoked" 
                  width={400} 
                  height={300}
                />
              ...
              <div className={styles.productInfo}>
                <span className={styles.brandName}>ROYAL OAK FLOORS</span>
                <h3>Smoked</h3>
              </div>
            </Link>
            
            {/* Product 15 - Integrated Refrigerator */}
            <Link href="/marketplace/products/integrated-refrigerator" className={styles.productCard}>
              <div className={styles.productImage}>
                <Image 
                  src="/images/products/integrated-refrigerator.jpg" 
                  alt="Integrated Refrigerator Freezer" 
                  width={400} 
                  height={300}
                />
              </div>
              <div className={styles.productInfo}>
                <span className={styles.brandName}>FISHER & PAYKEL</span>
                <h3>Integrated Refrigerator Freezer 76.2cm Ice & Water Series 9</h3>
              </div>
            </Link>
            
            {/* Product 16 - Pinto Basket Collection */}
            <Link href="/marketplace/products/pinto-basket-collection" className={styles.productCard}>
              <div className={styles.productImage}>
                <Image 
                  src="/images/products/pinto-basket.jpg" 
                  alt="Pinto Basket Collection" 
                  width={400} 
                  height={300}
                />
              </div>
              <div className={styles.productInfo}>
                <span className={styles.brandName}>CITTA</span>
                <h3>Pinto Basket Collection</h3>
              </div>
            </Link>
            
            {/* Product 17 - Linea Mini */}
            <Link href="/marketplace/products/linea-mini" className={styles.productCard}>
              <div className={styles.productImage}>
                <Image 
                  src="/images/products/linea-mini.jpg" 
                  alt="Linea Mini" 
                  width={400} 
                  height={300}
                />
              ...
              <div className={styles.productInfo}>
                <span className={styles.brandName}>LA MARZOCCO</span>
                <h3>Linea Mini</h3>
              </div>
            </Link>
            
            {/* Product 18 - Grayson Sofa */}
            <Link href="/marketplace/products/grayson-sofa" className={styles.productCard}>
              <div className={styles.productImage}>
                <Image 
                  src="/images/products/grayson-sofa.jpg" 
                  alt="Grayson Sofa" 
                  width={400} 
                  height={300}
                />
              ...
              <div className={styles.productInfo}>
                <span className={styles.brandName}>TIM WEBBER</span>
                <h3>Grayson Sofa</h3>
              </div>
            </Link>
          </div>
          ...
          <div className={styles.viewAllContainer}>
            <Link href="/marketplace/products" className={styles.viewAllButton}>
              VIEW ALL PRODUCTS
            </Link>
          </div>
        </div>
